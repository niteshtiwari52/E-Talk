...
export const signIn = (userData) => async (dispatch) => {
  try {
    ...
    const User = await axios({
      method: "POST",
      url: `https://e-talk-server.vercel.app/auth/api/user/login/`,
      data: { ...userData },
    });
    // console.log(User);
...
export const signUp = (userData) => async (dispatch) => {
  try {
    const User = await axios({
      method: "POST",
      url: `https://e-talk-server.vercel.app/auth/api/user`,
      data: { ...userData },
    });
...
export const userVerification = (data) => async (dispatch) => {
  try {
    ...
    const verificationLink = await axios({
      method: "POST",
      url: `https://e-talk-server.vercel.app/auth/api/user/resend/verificationlink`,
      data: { ...data },
    });
...
export const verifyEmailLink = (token) => async (dispatch) => {
  try {
    const verificationStatus = await axios({
      method: "PUT",
      url: `https://e-talk-server.vercel.app/auth/api/user/verify`,
      data: { token },
    });
...
export const forgotPassword = (data) => async (dispatch) => {
  try {
    ...
    const forgotPasswordStatus = await axios({
      method: "POST",
      url: `https://e-talk-server.vercel.app/auth/api/user/forgotpassword`,
      data: { ...data },
    });
...
export const resetPassword = (userData) => async (dispatch) => {
  try {
    ...
    const resetPasswordStatus = await axios({
      method: "POST",
      url: `https://e-talk-server.vercel.app/auth/api/user/resetpassword`,
      data: userData,
    });
