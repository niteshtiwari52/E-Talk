...
export const fetchChats = () => async (dispatch) => {
  try {
    const chats = await axios({
      method: "GET",
      url: `https://e-talk-server.vercel.app/auth/api/chat`,
    });
...
export const fetchUser = (Search) => async (dispatch) => {
  try {
    ...
    const newUser = await axios({
      method: "GET",
      url: `https://e-talk-server.vercel.app/auth/api/user?search=${Search}`,
    });
...
export const createGroupChat = (groupInfo) => async (dispatch) => {
  try {
    ...
    const newCreatedGroupChat = await axios({
      method: "POST",
      url: `https://e-talk-server.vercel.app/auth/api/chat/group`,
      data: { ...groupInfo },
    });
